...
const scripts = [
  {
    ...
    description:
      "Fold X's left column to an icon-only rail, keep the right column visible by default, preserve its floating-dock toggle, and remove the \"Live on X\" chip on post detail pages.",
